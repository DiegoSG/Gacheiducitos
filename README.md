...
2. Añadir `res://scripts/managers/Inventory.gd` como *Autoload* (singleton) y nombrarlo `Inventory`.
3. Opcional: cargar escena `res://scenes/tests/inventory_test.tscn` para probar el inventario/quest.
